...
func (cpu *Cpu) decodeExecute(instr byte) (cycles uint64) {
	...
	case 0x07:
		...
		newCarry := GetBit(cpu.A, 7)
		cpu.A = cpu.A << 1
		SetBit(&cpu.A, 0, newCarry)
	...
	case 0x17:
		...
		newCarry := GetBit(cpu.A, 7)
		cpu.A <<= 1
		SetBit(&cpu.A, 0, cpu.GetCarryFlag() == 1)
	...
	case 0x0F:
		...
		newCarry := GetBit(cpu.A, 0)
		cpu.A >>= 1
		SetBit(&cpu.A, 7, newCarry)
	...
	case 0x1f:
		...
		cpu.A >>= 1
		SetBit(&cpu.A, 7, cpu.GetCarryFlag() == 1)
